...
function verifyCompleteCleanup() {
  ...
  try {
    ...
    const isDbClean = tickets.count === 0 && bookings.count === 0 && batches.count === 0;
    const hasEssentials = countries.count > 0 && airlines.count > 0 && users.count > 0;
    ...
    if (isDbClean && hasEssentials) {
      ...
      console.log("🚀 The application is completely clean and ready for real business data");
      console.log("\n📋 TO-DO FOR USER:");
