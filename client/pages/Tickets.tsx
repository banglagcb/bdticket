...
function TicketRow({ ticket, showBuyingPrice, onView, onBook }: TicketRowProps) {
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'sold':
        return <Badge variant="outline" className="bg-gray-50 text-gray-700 border-gray-200">Sold</Badge>;
      default:
