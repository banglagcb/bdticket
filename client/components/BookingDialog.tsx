...
export default function BookingDialog({
  ...
  const calculateTotal = () => {
    ...
    return bookingDetails.paymentType === "partial" &&
      bookingDetails.partialAmount > 0
              ...
              <div key={stepNum} className="flex items-center">
                ...
                {stepNum < 4 && (
                  <div
                    className={`w-20 h-1 ${
                      stepNum < step
                        ? "bg-gradient-to-r from-luxury-gold to-luxury-bronze"
                        : "bg-gray-200"
                    }`}
                  />
                )}
                      ...
                      <div className="space-y-2 text-sm font-body">
                        ...
                        <div className="border-t border-border/30 pt-2 flex justify-between">
                          ...
                          <span className="font-semibold text-primary text-lg">
                            ৳
                            {(
                              ticket.sellingPrice * passengerInfo.paxCount
                            ).toLocaleString()}
                          </span>
                        </div>
                      </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setBookingDetails({
                                ...bookingDetails,
                                partialAmount: parseInt(e.target.value) || 0,
                              })
                            }
                    ...
                    {bookingDetails.paymentType === "partial" && (
                      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            <p className="font-body font-semibold text-yellow-800">
                              Partial Payment Notice
                            </p>
                            <p className="font-body text-sm text-yellow-700">
                              This booking will be locked for 24 hours. Full
